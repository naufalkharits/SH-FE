    ...
    return (
        ...
        <div className="flex justify-center gap-4 m-4">
            <div className="w-2/6 space-y-4">
                ...
                <div className="drop-shadow-low h-fit bg-white rounded p-4 space-y-2">
                    <h3>Deskripsi</h3>
            ...
            <div className="space-y-5">
                <div className="bg-white w-80 h-fit drop-shadow-high rounded space-y-4 p-4">
                ...
                <div className="bg-white w-80 h-fit drop-shadow-low rounded gap-2 p-4 flex items-center">
