...
const ModalBerhasil = ({ name, price, price_tawar, phone_number }) => {
            ...
            <div className="fixed inset-0 z-50 bg-gray-bg">
                <div className="flex h-screen items-center justify-center">
                    ...
                    <div className="h-fit w-96 rounded-2xl bg-white p-8 dark:bg-zinc-900">
                        ...
                        onClick={() => {
                            window.open(
                                `https://api.whatsapp.com/send?phone=62${updatedTx?.buyer?.phone_number}`
                            )
                        }}
