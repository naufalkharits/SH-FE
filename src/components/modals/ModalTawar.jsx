            ...
            <form className="" onSubmit={onSubmit}>
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="font-medium dark:text-white">Masukkan Harga Tawarmu</div>
                  ...
                  <div className="flex items-center gap-4 rounded-2xl p-4 shadow-md ring-1 ring-black ring-opacity-5 dark:ring-white dark:ring-opacity-10 sm:bg-smoke sm:shadow-none sm:ring-0 sm:dark:bg-zinc-800">
                    ...
                    <div className="space-y-1 dark:text-white">
                      ...
                      <div className="text-sm">{priceFormatter(product?.price)}</div>
                    </div>
                  </div>
                </div>
                <div>
                  <div className="mb-1 text-xs dark:text-white">Harga Tawar</div>
                  <input
