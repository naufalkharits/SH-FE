...
import { insertProduct, setProductsError, setShowProductsError } from "../redux/productsSlice"
            ...
            <div className="flex flex-wrap">
              {formValue.pictures &&
                formValue.pictures.map((image) => (
                  <img key={image} src={image} alt="" className="mr-4 h-24 w-24 object-contain" />
                ))}
              <label
