...
// login
export const login = createAsyncThunk("auth/login", async ({ formValue, navigate }, thunkAPI) => {
  try {
...
// get biodata
export const getBiodata = createAsyncThunk("biodata/getBiodata", async (userId, thunkAPI) => {
  try {
...
// google login
export const authResponse = createAsyncThunk("auth/googleLogin", async ({ code }, thunkAPI) => {
  try {
...
export const authSlice = createSlice({
  ...
  reducers: {
    ...
    setUser: (state, action) => {
      ...
      state.unixRefreshExp = dayjs(action.payload.refreshToken.expiredAt).unix()
      state.unixAccessExp = dayjs(action.payload.accessToken.expiredAt).unix()
    },
    logout: (state) => {
...
export const { setShowAuthError, resetError, setUser, logout } = authSlice.actions
